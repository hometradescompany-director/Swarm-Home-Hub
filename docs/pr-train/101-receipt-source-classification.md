# PR Train Slot 101: Provenance receipt source classification
...
Classify whether a receipt points to direct observation, connected-source evidence, user report, derived projection, or unresolved evidence.
