# PR Train Slot 183: Provider context-window metadata

Status: **planned contract slice, not runtime implementation**
Phase: **177-224 · provider and model offering adapters**

## Intent
Carry provider-declared context limits as versioned capability metadata rather than hardcoded universal facts.
