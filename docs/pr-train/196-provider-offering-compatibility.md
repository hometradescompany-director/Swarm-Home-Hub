# PR Train Slot 196: Provider compatibility projection

Status: **planned contract slice, not runtime implementation**
Phase: **177-224 · provider and model offering adapters**

## Intent
Describe compatibility claims as attributable/versioned relationships, not automatic interchangeability.
