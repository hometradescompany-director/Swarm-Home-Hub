# PR Train Slot 168: Atlas adapter recovery semantics

Status: **planned contract slice, not runtime implementation**
Phase: **129-176 · Atlas identity / permission / evidence adapters**

## Intent
Define explicit recovery from degraded transport while preserving queued/uncertain delivery evidence.
