# PR Train Slot 100: Provenance receipt envelope identity
...
Define the minimum identity envelope for a provenance receipt so receipts can be referenced without duplicating the evidence they describe.
