# PR Train Slot 167: Atlas adapter circuit-breaker semantics

Status: **planned contract slice, not runtime implementation**
Phase: **129-176 · Atlas identity / permission / evidence adapters**

## Intent
Specify bounded degradation when repeated Atlas failures occur without converting outage into local authority.
